...
const NvabarLogin: React.FC<Props> = ({ lang }) => {
  ...
  const nav = [
    ...
    {
      name: t("Graphic and design"),
      link: "",
    },
    {
      name: t("Programming and technology"),
      link: "",
    },
    {
      name: t("Electronic marketing"),
      link: "",
    },
    {
      name: t("Video and montage"),
      link: "",
    },
    {
      name: t("Writing content"),
      link: "",
    },
    {
      name: t("WordPress and SEO"),
      link: "",
    },
    {
      name: t("Advertisement design"),
      link: "",
    },
  ];
  return (
